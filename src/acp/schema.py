...
#   timestamp: 2025-10-08T18:16:04+00:00
...
class McpCapabilities(BaseModel):
    ...
    http: Annotated[
        Optional[bool], Field(description='Agent supports [`McpServer::Http`].')
    ] = False
    sse: Annotated[
        Optional[bool], Field(description='Agent supports [`McpServer::Sse`].')
    ] = False
...
class NewSessionRequest(BaseModel):
    ...
    mcpServers: Annotated[
        List[Union[McpServer1, McpServer2, McpServer3]],
        Field(
...
class CreateTerminalRequest(BaseModel):
    ...
    args: Annotated[
        Optional[List[str]], Field(description='Array of command arguments.')
    ] = None
...
class ReadTextFileRequest(BaseModel):
    ...
    limit: Annotated[
        Optional[int], Field(description='Maximum number of lines to read.', ge=0)
    ] = None
    line: Annotated[
        Optional[int],
